                    ...
                    <table className="table">
                      <thead>
                        <tr className="table-header">
                          ...
                          {/* <th rowSpan={2} width="25%" style={{ textAlign: 'center' }} className='dataTableHead border-right-white'>STLC Activities</th> */}

                          <th colSpan={duration} style={{ textAlign: 'center' }} className='dataTableHead'>Y-O-Y Cumulative Savings (%)</th>

                        </tr>
                        <tr className="table-header">
                          {/* <th width="30%" style={{ textAlign: 'center' }} className='dataTableHead border-right-white'>Selected AI Solutions</th>
                          <th width="25%" style={{ textAlign: 'center' }} className='dataTableHead border-right-white'>STLC Activities</th> */}
                          {(() => {
                            const arrh = [];
                        ...
                        {cognitiveSolutionList.map((cognitive, sl) => {
                          return [
                            <tr key={sl}>
                              ...
                              {/* <td className='dataTableText border-right'>{cognitive.stlcName}</td> */}
                              {(() => {
                                const arr = [];
              ...
              <div className="row">
                <div className="col-md-12">
                  <div className="table-responsive table-hover table-sales" style={{ width:'150%', height: '30em' }}>
                    <table className="table" style={{ textAlign: 'center', width: '130%' }}>
                      <thead>
                        <tr className="table-header">
